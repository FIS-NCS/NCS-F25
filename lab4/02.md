...
Follow the steps to install Wazuh agent (a deamon process) to continously monitor the terminal environment.

1. Install the agent, preconfigured with the endpoint name and address of the manager to contact
